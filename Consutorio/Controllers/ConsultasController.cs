...
using consutorio.Data;
using consutorio.Models;

namespace consutorio.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Sobrenome")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Sobrenome")] Consulta consulta)
        {
            if (id != consulta.id)
            {
                return NotFound();
